...
import * as TestHelpers_MockDbJS from './TestHelpers_MockDb.res.mjs';

import type {DynamicContractRegistry_t as InternalTable_DynamicContractRegistry_t} from 'envio/src/db/InternalTable.gen.js';

import type {MarketActivity_t as Entities_MarketActivity_t} from '../src/db/Entities.gen.js';

import type {Market_t as Entities_Market_t} from '../src/db/Entities.gen.js';

import type {RawEvents_t as InternalTable_RawEvents_t} from 'envio/src/db/InternalTable.gen.js';

import type {eventLog as Types_eventLog} from './Types.gen.js';

import type {rawEventsKey as InMemoryStore_rawEventsKey} from 'envio/src/InMemoryStore.gen.js';
...
export type entities = { readonly Market: entityStoreOperations<Entities_Market_t>; readonly MarketActivity: entityStoreOperations<Entities_MarketActivity_t> };
