...
import type * as GeneratedEntities from "./db/Entities.gen.ts";
...
export type HandlerContext = {
  ...
  readonly Market: {
     ...
     */
    readonly get: (id: string) => Promise<Entities["Market"] | undefined>,
    /**
     * Load the entity Market from the storage by ID.
     * If the entity is not found, throws an error.
     */
    readonly getOrThrow: (id: string, message?: string) => Promise<Entities["Market"]>,
    readonly getWhere: GeneratedEntities.Market_indexedFieldOperations,
    /**
     ...
     */
    readonly getOrCreate: (entity: Entities["Market"]) => Promise<Entities["Market"]>,
    /**
     * Set the entity Market in the storage.
     */
    readonly set: (entity: Entities["Market"]) => void,
    /**
  ...
  readonly MarketActivity: {
    /**
     * Load the entity MarketActivity from the storage by ID.
     * If the entity is not found, returns undefined.
     */
    readonly get: (id: string) => Promise<Entities["MarketActivity"] | undefined>,
    /**
     * Load the entity MarketActivity from the storage by ID.
     * If the entity is not found, throws an error.
     */
    readonly getOrThrow: (id: string, message?: string) => Promise<Entities["MarketActivity"]>,
    readonly getWhere: GeneratedEntities.MarketActivity_indexedFieldOperations,
    /**
     * Returns the entity MarketActivity from the storage by ID.
     * If the entity is not found, creates it using provided parameters and returns it.
     */
    readonly getOrCreate: (entity: Entities["MarketActivity"]) => Promise<Entities["MarketActivity"]>,
    /**
     * Set the entity MarketActivity in the storage.
     */
    readonly set: (entity: Entities["MarketActivity"]) => void,
    /**
     * Delete the entity MarketActivity from the storage.
     *
     * The 'deleteUnsafe' method is experimental and unsafe. You should manually handle all entity references after deletion to maintain database consistency.
     */
    readonly deleteUnsafe: (id: string) => void,
...
export type Market = Entities["Market"];
export type MarketActivity = Entities["MarketActivity"];
